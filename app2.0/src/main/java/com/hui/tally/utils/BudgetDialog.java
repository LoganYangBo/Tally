        ...
        switch (v.getId()) {
            ...
            case R.id.dialog_budget_btn_ensure:
                ...
                if (TextUtils.isEmpty(data)) {
                    Toast.makeText(getContext(),"Input cannot be 0！",Toast.LENGTH_SHORT).show();
                    return;
                }
                float money = Float.parseFloat(data);
                if (money<=0) {
                    Toast.makeText(getContext(),"The amount of budget should bigger than 0",Toast.LENGTH_SHORT).show();
                    return;
                }
