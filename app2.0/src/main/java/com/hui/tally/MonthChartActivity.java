...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        ...
        dateTv.setText(year+" /"+month+" 's Bill");
        inTv.setText("There are "+incountItemOneMonth+" receipts records, $ "+inMoneyOneMonth);
        outTv.setText("There are "+outcountItemOneMonth+" payments records, $ "+outMoneyOneMonth);
